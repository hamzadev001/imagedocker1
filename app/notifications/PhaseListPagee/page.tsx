...
import { FaSearch, FaFilter, FaMapMarkerAlt, FaBell } from "react-icons/fa";
...
export default function PhaseListPagee() {
  ...
  const fetchEstablishments = async () => {
    try {
      const response = await fetch("http://hamzaepicness.atwebpages.com/fetch_json1.php");
  ...
  return (
    <PageLayout title="Pending Review Phase">
